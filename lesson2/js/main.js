...
function ex1() {
    //Ex1
    //var a = 1, b = 1, c, d;
    //c = ++a; alert(c);            // 2: В выражении использован префиксный инкремент, это означает, что сначала значение b будет
    // увеличено на 1, а затем выполнится оператор присваивания
    //d = b++; alert(d);            // 1: В этом выражении использован постфиксный инкремент, что приведет к выполнению оператора
    // присваивания до увеличения значения b на 1.
    //c = (2+ ++a); alert(c);       // 5: Значение a увеличится на 1 префиксным инкрементом, затем выполняется сложение с 2
    //d = (2+ b++); alert(d);       // 4: В начале выполняется сложение переменной b и 2, выполнится оператор присваивания. а только
                                    // затем будет выполнен постфиксный инкремент.
    //alert(a);                     // 3: Значение a увеличивалось на 1 в строках 45, 49
    //alert(b);                     // 3: Значение b увеличивалось на 1 в строках 47, 50
}
...
function power(val, pow){
    console.log("power call: val = "+val+", pow = "+pow);
    if(val===NaN || pow===NaN){
        return NaN;
    }
